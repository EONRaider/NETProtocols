...
def raw_icmpv4_header():
    return b"\x08\x00\x83\xf7\x00\x01\x00\x01\xbf\xc8\xea\x61\x00\x00\x00\x00" \
...
class TestICMP:
    def test_build_icmpv4_header(self, mock_icmpv4_header):
        ...
        assert mock_icmpv4_header.encapsulated_proto is None
    ...
    def test_decode_icmpv4_header(self, raw_icmpv4_header):
        ...
        assert icmpv4_header.encapsulated_proto is None
